...
#define TYPE_FORMAT_STRING_SIZE   1009                              
...
extern const MIDL_SERVER_INFO ICloser_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ICloser_ProxyInfo;
...
/* 26 */	NdrFcShort( 0x3e6 ),	/* Type Offset=998 */
...
/* 20 */	
			0x11, 0x0,	/* FC_RP */
/* 22 */	NdrFcShort( 0x3d0 ),	/* Offset= 976 (998) */
/* 24 */	
			0x12, 0x0,	/* FC_UP */
...
/* 510 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 512 */	NdrFcShort( 0xff62 ),	/* Offset= -158 (354) */
/* 514 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 516 */	
...
/* 940 */	
			0x12, 0x10,	/* FC_UP [pointer_deref] */
/* 942 */	NdrFcShort( 0xfdb4 ),	/* Offset= -588 (354) */
/* 944 */	
			0x12, 0x10,	/* FC_UP [pointer_deref] */
/* 946 */	NdrFcShort( 0xfc50 ),	/* Offset= -944 (2) */
/* 948 */	
			0x12, 0x10,	/* FC_UP [pointer_deref] */
...
/* Object interface: ICloser, ver. 0.0,
   GUID={0xEFC4506F,0xAD56,0x4D56,{0xB2,0x48,0x93,0xFE,0x07,0xFB,0x37,0xCC}} */

#pragma code_seg(".orpc")
static const unsigned short ICloser_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ICloser_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ICloser_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ICloser_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _ICloserProxyVtbl = 
{
    &ICloser_ProxyInfo,
    &IID_ICloser,
    ...
    (void *) (INT_PTR) -1 /* ICloser::NavigateComplete2 */
};


static const PRPC_STUB_FUNCTION ICloser_table[] =
{
...
CInterfaceStubVtbl _ICloserStubVtbl =
{
    &IID_ICloser,
    &ICloser_ServerInfo,
    8,
...
const CInterfaceProxyVtbl * _Noime4ntr_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICloserProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Noime4ntr_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICloserStubVtbl,
    0
};

PCInterfaceName const _Noime4ntr_InterfaceNamesList[] = 
{
    "ICloser",
    0
};

const IID *  _Noime4ntr_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _Noime4ntr_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Noime4ntr, pIID, n)

int __stdcall _Noime4ntr_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Noime4ntr_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Noime4ntr_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Noime4ntr_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Noime4ntr_StubVtblList,
    (const PCInterfaceName * ) & _Noime4ntr_InterfaceNamesList,
    (const IID ** ) & _Noime4ntr_BaseIIDList,
    & _Noime4ntr_IID_Lookup, 
    1,
    2,
