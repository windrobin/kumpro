...
Section "Dummy Section" SecDummy
  ...
  File "bin\release\AccessTabstop.exe"
  File "bin\release\AccessTabstop.exe.manifest"
  File "bin\release\AccessTabstop.pdb"
  ...
  Exec "$INSTDIR\AccessTabstop.exe"
